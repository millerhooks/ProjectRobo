/******************************************************
    Proof of concept OSC based control of a servo
    driven arm. It's a mess. Make the best.
    
    03/2011 Peter Hinson
******************************************************/
...
Vector right_hand = new Vector(0, 0, 0);
Vector head       = new Vector(0, 0, 0);
